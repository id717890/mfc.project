...
@Component({
    selector: 'action-modal-content',
    templateUrl: 'app/work/action/action-edit.component.html'
})

export class ActionEditComponent extends BaseEditComponent<Action> implements AfterViewInit {
    ...
    constructor(
        @Inject(MD_DIALOG_DATA) data: BaseContext<Action>
        , public dialogRef: MdDialogRef<ActionEditComponent>
